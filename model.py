...
class PointNetLike(nn.Module):
    ...
    def forward(self, point_set, scalars):
        ...
        # assert point_set.shape[1] == self.num_points, f"Expected {self.num_points} points, got {point_set.shape[1]}"
        # assert scalars.shape[1] == 3, f"Expected 3 scalars, got {scalars.shape[1]}"
